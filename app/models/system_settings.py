...
class SystemSettings(Base):
    ...
    # App Branding & Config
    app_name = Column(String(100), default="SIAB1 — Sistem Informasi Asesmen Berintegritas", nullable=True)
    ...
    def to_dict(self):
        ...
        return {
            ...
            "app_name": self.app_name or "SIAB1 — Sistem Informasi Asesmen Berintegritas",
